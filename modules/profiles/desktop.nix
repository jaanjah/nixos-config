...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    # The "electron-39.8.10" entry in nixpkgs.config.permittedInsecurePackages
    # lives in modules/system.nix, gated on this profile being enabled.
    # Remove that entry once bitwarden-desktop moves to a supported Electron.
